...
import 'package:gostore_app/core/model/place_detail.dart';
import 'package:gostore_app/core/model/predicition.dart';
import 'package:rxdart/src/streams/timer.dart';
import 'package:rxdart/src/transformers/backpressure/backpressure.dart';

class CustomGooglePlacesAutoCompleteTextFormField extends StatefulWidget {
  ...
  const CustomGooglePlacesAutoCompleteTextFormField({
    super.key,
  ...
  @override
  State<CustomGooglePlacesAutoCompleteTextFormField> createState() =>
      _CustomGooglePlacesAutoCompleteTextFormFieldState();
}

class _CustomGooglePlacesAutoCompleteTextFormFieldState
    extends State<CustomGooglePlacesAutoCompleteTextFormField> {
